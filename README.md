...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/curly-darkness-90b8)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/curly-darkness-90b8
```

A live public deployment of this template is available at [https://curly-darkness-90b8.templates.workers.dev](https://curly-darkness-90b8.templates.workers.dev)
